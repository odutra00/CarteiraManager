...
class Gui:
    ...
    lblMercado      = Label(frameButoes, text="Mercado")
    lblPapel        = Label(frameButoes, text="Ação")
    lblStatus       = Label(frameButoes, text="Status")
    lblData         = Label(frameButoes, text="Data")
    lblValorCompra        = Label(frameButoes, text="Valor")
    lblQuantidade   = Label(frameButoes, text="Quantidade")
    lblCustos       = Label(frameButoes, text="Custos")
    ...
    entPapel        = Entry(frameButoes, textvariable=txtPapel)
    ...
    entData         = Entry(frameButoes, textvariable=txtData)
    entValor        = Entry(frameButoes, textvariable=txtValorCompra)
    entQuantidade   = Entry(frameButoes, textvariable=txtQuantidade)
    entCustos       = Entry(frameButoes, textvariable=txtCustos)
    ...
    labelsColunas = Label(frameList, text="   MKT\t Papel\t Status\t        Data\t             Preço         PM            N          NC     Custos")
    listPapels   = Listbox(frameList, width=68, height=15, font=mono_font)
    ...
    scrollPapelsY.grid(row=1, column=1, rowspan=9, sticky='nesw')
    #scrollPapelsX.grid(row=10, column=1, rowspan=9, sticky='nesw')

    #Criando Botoes
    btnViewAll     = Button(frameButoes, text="Ver todos")
    btnBuscar      = Button(frameButoes, text="Buscar")
    btnInserir     = Button(frameButoes, text="Inserir")
    btnUpdate      = Button(frameButoes, text="Atualizar Selecionado")
    btnDel         = Button(frameButoes, text="Deletar Selecionado")
    btnClose       = Button(frameButoes, text="Fechar")
    ...
    figDesempenho = plt.figure(5, figsize=(6.7, 5))
    ...
    frameIRPFBoth = LabelFrame(window, text=txtLabelFrameBoth)#, padx=20, pady=20)
    btnCalculaIRPFMensal = Button(frameIRPFBoth, text="Calcula IRPF Mensal")
    ...
    labelMercado = Label(frameIRPF, text="Mercado")
    labelVendas = Label(frameIRPF, text="Vendas")
    labelLucroBruto = Label(frameIRPF, text="L. Bruto")
    labelDespesasMensais = Label(frameIRPF, text="Despesas")
    labelLucroLiquido = Label(frameIRPF, text="L. Líquido")
    labelLucroLiquidoPercentual = Label(frameIRPF, text="L. Líquido %")
    labelIRPFRetido = Label(frameIRPF, text="IRPF Retido")
    labelImpostosDevidos = Label(frameIRPF, text="IRPF Devido")

    #entMercadoIRPF = Entry(frameIRPF, textvariable=txtMercadoIRPF, state='disabled', width=2)
    entVendas = Entry(frameIRPF, textvariable=txtVendas, state='disabled', width=12)
    entLucroBruto = Entry(frameIRPF, textvariable=txtLucroBruto, state='disabled', width=12)
    entDespesasMensais = Entry(frameIRPF, textvariable=txtDespesasMensais, state='disabled', width=12)
    entLucroLiquido = Entry(frameIRPF, textvariable=txtLucroLiquido, state='disabled', width=12)
    entLucroLiquidoPercentual = Entry(frameIRPF, textvariable=txtLucroLiquidoPercentual, state='disabled', width=12)
    entIRPFRetido = Entry(frameIRPF, textvariable=txtIRPFRetidoFonte, state='disabled', width=12)
    entImpostosDevidos = Entry(frameIRPF, textvariable=txtImpostosDevidos, state='disabled', width=12)
    ...
    labelMercadoDT = Label(frameIRPFDayTrade, text="Mercado")
    labelVendasDT = Label(frameIRPFDayTrade, text="Vendas")
    labelLucroBrutoDT = Label(frameIRPFDayTrade, text="L. Bruto")
    labelDespesasMensaisDT = Label(frameIRPFDayTrade, text="Despesas")
    labelLucroLiquidoDT = Label(frameIRPFDayTrade, text="L. Líquido")
    labelLucroLiquidoPercentualDT = Label(frameIRPFDayTrade, text="L. Líquido %")
    labelIRPFRetidoDT = Label(frameIRPFDayTrade, text="IRPF Retido")
    labelImpostosDevidosDT = Label(frameIRPFDayTrade, text="IRPF Devido")

    entMercadoIRPFDT = Entry(frameIRPFDayTrade, textvariable=txtMercadoIRPFDT, state='disabled', width=12)
    entVendasDT = Entry(frameIRPFDayTrade, textvariable=txtVendasDT, state='disabled', width=12)
    entLucroBrutoDT = Entry(frameIRPFDayTrade, textvariable=txtLucroBrutoDT, state='disabled', width=12)
    entDespesasMensaisDT = Entry(frameIRPFDayTrade, textvariable=txtDespesasMensaisDT, state='disabled', width=12)
    entLucroLiquidoDT = Entry(frameIRPFDayTrade, textvariable=txtLucroLiquidoDT, state='disabled', width=12)
    entLucroLiquidoPercentualDT = Entry(frameIRPFDayTrade, textvariable=txtLucroLiquidoPercentualDT, state='disabled', width=12)
    entIRPFRetidoDT = Entry(frameIRPFDayTrade, textvariable=txtIRPFRetidoFonteDT, state='disabled', width=12)
    entImpostosDevidosDT = Entry(frameIRPFDayTrade, textvariable=txtImpostosDevidosDT, state='disabled', width=12)
    ...
    frameIndTec = LabelFrame(window, text="Indicadores Técnicos")#, padx=20, pady=20)
    #Labels
    #labelPL = Label(frameIndTec, text="P/L = ")
    #Entries
    #entPL = Entry(frameIndTec, textvariable=txtPL, state='disabled')
    #Caixa de Texto
    textAreaIndicators = Text(frameIndTec, width=44, height=12, font=mono_font)
    ...
    frameIndFund = LabelFrame(window, text="Informações")#, padx=20, pady=20)
    #Caixa de Texto
    textAreaIndicatorsFund = Text(frameIndFund, width=44, height=10, font=mono_font)
